            ...
            <div className="col-md-7">
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-3">
                  ...
                  <input type="text" className="form-control FormularioReportarMascota" name="color" value={formData.color} onChange={handleChange} />
                </div>
                ...
                <div className="mb-3">
                  ...
                  <textarea className="form-control FormularioReportarMascota" rows="3" name="description" value={formData.description} onChange={handleChange}></textarea>
                </div>

                <div className="mb-3">
                  <label className="form-label">Correo electronico para contactar</label>
                  <input type="email" className="form-control FormularioReportarMascota" name="email" value={formData.email} onChange={handleChange}></input>
                </div>
